...
**Service Charge (Propina) Calculation (Updated Oct 18, 2025):** When "Propina 10% Incluida" is selected, product prices are assumed to ALREADY include the 10% service charge. The system extracts the service charge using reverse calculation (Subtotal = Price / 1.10) to obtain the base subtotal. The ITBIS is calculated on this subtotal WITHOUT the service charge. Finally, the service charge is added back to the total. Formula: `Total = Subtotal (without service charge) + ITBIS (18% of Subtotal) + Service Charge`. Example: Product priced at RD$ 330 with propina incluida → Subtotal (without tip): RD$ 300, Service Charge extracted: RD$ 30, ITBIS 18%: RD$ 54, Total: RD$ 384 (300 + 54 + 30).
