...
**Service Charge (Propina) Calculation (Updated Oct 18, 2025):** When "Propina 10% Incluida" is selected, product prices are assumed to ALREADY include the 10% service charge. The system extracts the service charge using reverse calculation (Subtotal = Price / 1.10) and displays it separately for informational purposes. The service charge is NOT added to the total or included in the tax base for ITBIS calculation. Formula: `Total = Subtotal (without service charge) + ITBIS (18% of Subtotal)`. Example: Product priced at RD$ 110 with propina incluida → Subtotal: RD$ 100, Service Charge (extracted, display only): RD$ 10, ITBIS 18%: RD$ 18, Total: RD$ 118.
